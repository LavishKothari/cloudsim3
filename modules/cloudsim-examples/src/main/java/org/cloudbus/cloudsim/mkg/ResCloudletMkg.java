...
public class ResCloudletMkg {
    ...
    //ATUL
    /**
     * Estimated Finish Time of a cloudlet
     */
     ...
     */
    public ResCloudletMkg(Cloudlet cloudlet) {
     ...
     * @see gridsim.CloudSim#clock()
     */
    public ResCloudletMkg(Cloudlet cloudlet, long startTime, int duration, int reservID) {
        this.cloudlet = cloudlet;
    ...
    public boolean setCloudletStatus(int status) {
        ...
        try {
            ...
            if (prevStatus == Cloudlet.INEXEC) {
                ...
                //ATUL
                if (status == Cloudlet.CANCELED || status == Cloudlet.PAUSED || status == Cloudlet.SUCCESS || status == Cloudlet.FAILED) {
    ...
    /**
     * A method that gets the length of cloudlet that has been completed.
     *
     * @param miLength cloudlet length in Instructions (I)
     * @pre miLength >= 0.0
     * @post $none
    ...
    public long getCloudletFinishedSoFar() {
        return this.cloudletFinishedSoFar;
    }
    ...
    /**
     * gets Estimated Finish Time of a cloudlet
     *
     * @return
     */
    ...
    /**
     * Sets EstimatedFinishTime of a cloudlet
     *
