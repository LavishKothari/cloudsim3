...
public abstract class CloudletSchedulerMkg extends CloudletScheduler{
	
	/** Vm object to be retrieved in the CloudletScheduler */
	public VmMkg vm;
	...
	//ATUL
	/**
	 * Fails execution of a cloudlet.
	 * 
	 * @param clId ID of the cloudlet being failed
	 * @return the failed cloudlet, $null if not found
	 * @pre $none
	 * @post $none
	 */
	public abstract Cloudlet cloudletFail(int clId);
	 ...
	 * @post $none
	 */
	public abstract void cloudletFinish(ResCloudletMkg rcl);
	...
	//ATUL
	/**
	 * Informs about failure of some cloudlet in the VM managed by this scheduler.
	 * 
	 * @return $true if there is at least one cloudlet has failed; $false otherwise
	 * @pre $none
	 * @post $none
	 */
	public abstract boolean isFailedCloudlets();
	...
	*/
	 ...
	 */
	public abstract double getTotalCurrentAvailableMipsForCloudlet(ResCloudletMkg rcl, List<Double> mipsShare);
	 ...
	 */
	public abstract double getTotalCurrentRequestedMipsForCloudlet(ResCloudletMkg rcl, double time);
	 ...
	 */
	public abstract double getTotalCurrentAllocatedMipsForCloudlet(ResCloudletMkg rcl, double time);
	...
	//ATUL
	/**
	 * Setter Method for Vm Scheduler
	 * @param vm
	 */
	public void setVm(VmMkg vm) {
		this.vm = vm;
	}
	...
	public abstract <T extends ResCloudletMkg> List<T> getCloudletFailedList();
	
	public abstract <T extends ResCloudletMkg> List<T> getCloudletExecList();
}
